...
pub fn set_method(val: &str) -> HostResult<()> {
...
pub fn set_url(val: &str) -> HostResult<()> {
...
pub fn set_body(val: &str) -> HostResult<()> {
...
pub fn set_body_field(key: &str, val: &str) -> HostResult<()> {
...
pub fn set_header(key: &str, val: &str) -> HostResult<()> {
...
pub fn set_url_param(key: &str, val: &str) -> HostResult<()> {
...
pub fn set_state(key: &str, val: &str) -> HostResult<()> {
